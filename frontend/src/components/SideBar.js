          ...
          <button>
            ...
            <a className="flex w-full cursor-pointer items-center rounded-lg px-4 py-2 transition duration-300 ease-in-out hover:bg-zinc-800 hover:text-white">
              ...
              <span className="ml-3 font-bold">Dashboard</span>
                ...
                <div className="mb-4">
                  <div className="flex w-full items-center justify-between">
            <a className="flex w-full cursor-pointer items-center rounded-lg px-4 py-2 transition duration-300 ease-in-out hover:bg-zinc-800 hover:text-white">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cloud-rain-heavy-fill" viewBox="0 0 16 16">
            ...
            <li className="transition duration-300 ease-in-out hover:text-white">
              <a href="#" className="flex items-center">
                Favorites
                <span className="ml-4 flex h-8 w-8 items-center justify-center rounded-full bg-zinc-800 text-xs">78</span>
              </a>
            </li>
                  </ul>
                </div>
            ...
            <a className="flex w-full cursor-pointer items-center rounded-lg px-4 py-2 transition duration-300 ease-in-out hover:bg-zinc-800 hover:text-white">
              ...
              {/* <!-- Bottom --> */}
              <div className="flex items-center border-t-2 border-zinc-700 p-4">
                ...
                <a href="https://www.youtube.com/channel/UCZXcplsSliFfK3vGUjCKY2A" className="ml-2 text-sm" target="_blank">Tekku Bit</a>
